...
export async function generateImagePrompt(notebookName:string){
    //generates a detailed description of the desired image 
    try{
        const response = await openai.createChatCompletion({
            ...
            messages: [
                ...
                {
                    role:"user",
                    content: `Please generate a thumbnail description for my notebook titled ${notebookName}`
                }
            ]
        });
